...
#define _DUTY_MAX 1974 // 2000
#define _DUTY_NEU 1500 // 1500
#define _DUTY_MIN 707 // 1000

#define _SERVO_ANGLE_DIFF  38  // Replace with |D - E| degree
...
float volt_to_distance(int a_value)
{
  ...
  // return (6762.0 / (a_value - 9) - 4.0) * 10.0; 
    return 869 + -4.28*a_value + 7.55*pow(0.1, 3)*a_value*a_value + -4.68*pow(0.1, 6)*a_value*a_value*a_value;
}
